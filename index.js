...
console.log(createMenuItem("cheeseburger","4","supper"));
console.log(createMenuItem("bacon","2","breakfast"));
...
export const burger = {
  ...
  discount: function (discounted){
    if( discounted === "teacher" || discounted === "student"){
...
*/
reviews.push({name: "Chase", rating:10, feedback: "Nice guy"});
...
*/
 ...
 function getReviewByRating(reviews, score) {
    for(let i = reviews; i <= score; i++){
    if(i.rating.includes(score)){
     }
    }
    return reviews
  }
